package video.xdownloader.extractor.xpress;
...
public class DownloadFinishedReceiver extends BroadcastReceiver {
    ...
    private void convertM4a(String inFilePath, String title, String artist) {
        ...
        try {
            com.googlecode.mp4parser.authoring.Movie inAudio = MovieCreator.build(inFilePath);
    ...
    private void mergeMp4(String inFilePathAudio, String inFilePathVideo) {
        ...
        try {
            com.googlecode.mp4parser.authoring.Movie video = MovieCreator.build(inFilePathVideo);
            com.googlecode.mp4parser.authoring.Movie audio = MovieCreator.build(inFilePathAudio);
